...
// import bjp from '../../image/bharatiya-janata-party.png'; // Import image if needed
...
const Party = () => {
  ...
  // No longer needed if not used for form submission
  // let filedata = (e) => {
  //   e.preventDefault();
        ...
        <section>
          ...
          <>
            <Dialog open={open} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
              <DialogTitle id="alert-dialog-title">{"create party list"}</DialogTitle>
              <DialogContent>
                  ...
                  <div className='grid gap-4 mb-4 grid-cols-2'>
                    ...
                    <div className='col-span-2 mb-2'>
                      ...
                      <input
                        type="file"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        // onChange={filedata} // Remove if not used
                        required
                      />
                    </div>
                    <div className='col-span-2 mb-2'>
                    ...
                    <button type='submit' onClick={partysubmin}>
                      Submit
                    </button>
                  </div>
                </DialogContentText>
